...
本仓库只发布棋牌游戏后端代码，不包含客户端工程、客户端资源或客户端构建产物。

当前配套客户端基于 **Cocos Creator 3.8.8** 迁移开发，客户端工程不上传 GitHub。需要完整客户端、资源、界面和可运行构建包，请联系作者单独购买。
...
客户端版本和配套内容会持续维护更新；GitHub 中的本仓库用于展示后端架构、服务端实现和联调基础，不代表客户端源码的授权范围。
...
* 客户端工程不在本仓库发布；如需 Cocos Creator 3.8.8 客户端及配套资源，请联系 `mszlu521` 咨询购买
